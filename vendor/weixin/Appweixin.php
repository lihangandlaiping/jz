...
if (typeof WeixinJSBridge == "undefined"){
   ...
   onBridgeReady();
    ...
    function get_openid()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if(empty($openid['nickname']))$openid['nickname']='微信会员';
                session('wx_openid1',$openid);
                return $openid;
            }
        }
    }
    ...
    public function authorize()
    {
        ...
        if($wx_user_info)return $wx_user_info;
        if (!isset($_GET['code'])) {
            $redirect_url =  'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
